    ...
    <>
      ...
      >
        <div className="w-1/4 flex justify-center flex-col text-center max-md:w-full">
          ...
          <div>Check out our upcoming events – or inquire about having your next hangout in our taproom. For events please email us at <a className="underline underline-offset-8">events@ministryofbrewing.com</a> </div>
        </div>
        <div className="w-1/4 flex justify-center flex-col text-center max-md:w-full">
          <div className="flex justify-center h-[80px]">
            <Image
