...
const Hero = ({}) => {
  ...
  return (
    <div className="flex justify-center items-center text-[20px] font-[600] w-full h-full">
      <div className="w-[600px] h-[300px] bg-[#6B6867] opacity-80 py-8 flex justify-start flex-col text-center text-white rounded-xl shadow-2xl  gap-y-3 max-md:h-[450px]">
        <section
          className="flex justify-center items-center"
        >
          <ul className="font-[600] px-[50px] max-sm:px-[50px]">
