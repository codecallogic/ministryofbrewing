...
const Footer = ({}) => {
  ...
  return (
    <section className="mt-5 bg-gradient-to-l to-schemefive from-5% from-schemefive h-[350px] bg-cover bg-centerbg-no-repeat text-white flex flex-col max-lg:h-[100%]">
